...
import com.ami.ddframe.job.cloud.scheduler.fixture.CloudAppJsonConstants;
import com.ami.ddframe.job.cloud.scheduler.fixture.CloudJsonConstants;
import com.ami.ddframe.job.cloud.scheduler.fixture.TaskNode;
import com.ami.ddframe.job.cloud.scheduler.state.failover.FailoverTaskInfo;
import com.ami.ddframe.job.cloud.scheduler.state.running.RunningService;
...
import com.ami.ddframe.job.event.type.JobStatusTraceEvent.Source;
import com.ami.ddframe.job.event.type.JobStatusTraceEvent.State;
...
import static com.ami.ddframe.job.cloud.scheduler.restful.RestfulTestsUtil.sentGetRequest;
import static com.ami.ddframe.job.cloud.scheduler.restful.RestfulTestsUtil.sentRequest;
