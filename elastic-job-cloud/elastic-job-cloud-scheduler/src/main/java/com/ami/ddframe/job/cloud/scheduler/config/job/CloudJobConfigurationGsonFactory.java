...
package com.ami.ddframe.job.cloud.scheduler.config.job;
...
import static com.ami.ddframe.job.cloud.scheduler.config.constants.CloudConfigurationConstants.APPLICATION_CONTEXT;
import static com.ami.ddframe.job.cloud.scheduler.config.constants.CloudConfigurationConstants.APP_NAME;
import static com.ami.ddframe.job.cloud.scheduler.config.constants.CloudConfigurationConstants.BEAN_NAME;
import static com.ami.ddframe.job.cloud.scheduler.config.constants.CloudConfigurationConstants.CPU_COUNT;
import static com.ami.ddframe.job.cloud.scheduler.config.constants.CloudConfigurationConstants.JOB_EXECUTION_TYPE;
