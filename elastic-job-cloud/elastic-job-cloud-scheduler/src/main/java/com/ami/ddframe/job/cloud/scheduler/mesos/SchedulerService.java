...
import com.ami.ddframe.job.cloud.scheduler.config.job.CloudJobConfigurationListener;
import com.ami.ddframe.job.cloud.scheduler.env.BootstrapEnvironment;
import com.ami.ddframe.job.cloud.scheduler.env.MesosConfiguration;
import com.ami.ddframe.job.cloud.scheduler.ha.FrameworkIDService;
import com.ami.ddframe.job.cloud.scheduler.producer.ProducerManager;
import com.ami.ddframe.job.cloud.scheduler.restful.RestfulService;
...
import static com.ami.ddframe.job.cloud.scheduler.env.MesosConfiguration.FRAMEWORK_FAILOVER_TIMEOUT_SECONDS;
import static com.ami.ddframe.job.cloud.scheduler.env.MesosConfiguration.FRAMEWORK_NAME;
