...
package com.ami.ddframe.job.cloud.scheduler.ha;

import com.ami.ddframe.job.cloud.scheduler.mesos.SchedulerService;
import com.ami.ddframe.job.exception.JobSystemException;
import com.ami.ddframe.job.reg.base.CoordinatorRegistryCenter;
import com.ami.ddframe.job.reg.base.ElectionCandidate;
