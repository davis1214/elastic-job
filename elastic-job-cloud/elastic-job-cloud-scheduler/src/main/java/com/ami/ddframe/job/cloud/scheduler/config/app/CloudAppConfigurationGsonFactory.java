...
package com.ami.ddframe.job.cloud.scheduler.config.app;
...
import static com.ami.ddframe.job.cloud.scheduler.config.constants.CloudConfigurationConstants.APP_CACHE_ENABLE;
import static com.ami.ddframe.job.cloud.scheduler.config.constants.CloudConfigurationConstants.APP_NAME;
import static com.ami.ddframe.job.cloud.scheduler.config.constants.CloudConfigurationConstants.APP_URL;
import static com.ami.ddframe.job.cloud.scheduler.config.constants.CloudConfigurationConstants.BOOTSTRAP_SCRIPT;
import static com.ami.ddframe.job.cloud.scheduler.config.constants.CloudConfigurationConstants.CPU_COUNT;
import static com.ami.ddframe.job.cloud.scheduler.config.constants.CloudConfigurationConstants.EVENT_TRACE_SAMPLING_COUNT;
import static com.ami.ddframe.job.cloud.scheduler.config.constants.CloudConfigurationConstants.MEMORY_MB;
