...
package com.ami.ddframe.job.cloud.executor;

import com.ami.ddframe.job.api.JobType;
import com.ami.ddframe.job.cloud.executor.TaskExecutor.TaskThread;
import com.ami.ddframe.job.cloud.executor.fixture.TestJob;
...
public final class TaskExecutorThreadTest {
    ...
    public void assertLaunchTaskWithWrongElasticJobClass() {
        ...
        try {
            ...
            assertTrue(ex.getMessage().startsWith("Elastic-Job: Class 'com.ami.ddframe.job.cloud.executor.TaskExecutorThreadTest' must implements ElasticJob interface."));
        }
    }
