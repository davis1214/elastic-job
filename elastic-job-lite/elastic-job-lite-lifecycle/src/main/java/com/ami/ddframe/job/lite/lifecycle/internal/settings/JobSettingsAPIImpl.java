...
import com.ami.ddframe.job.lite.internal.storage.JobNodePath;
...
public final class JobSettingsAPIImpl implements JobSettingsAPI {
    ...
    private void buildSimpleJobSettings(final String jobName, final JobSettings result, final LiteJobConfiguration liteJobConfig) {
        ...
        result.setFixedRate(liteJobConfig.getTypeConfig().getCoreConfig().getFixedRate());
    }
    ...
    public void updateJobSettings(final JobSettings jobSettings) {
        ...
        Preconditions.checkArgument(!(Strings.isNullOrEmpty(jobSettings.getCron()) && jobSettings.getFixedRate() == 0), "cron can not be empty while fixedRate is 0.");
