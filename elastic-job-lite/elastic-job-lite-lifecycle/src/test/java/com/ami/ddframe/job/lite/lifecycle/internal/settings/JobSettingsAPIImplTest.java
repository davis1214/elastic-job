...
package com.ami.ddframe.job.lite.lifecycle.internal.settings;

import com.ami.ddframe.job.executor.handler.JobProperties.JobPropertiesEnum;
import com.ami.ddframe.job.executor.handler.impl.DefaultExecutorServiceHandler;
import com.ami.ddframe.job.executor.handler.impl.DefaultJobExceptionHandler;
import com.ami.ddframe.job.lite.lifecycle.api.JobSettingsAPI;
import com.ami.ddframe.job.lite.lifecycle.domain.JobSettings;
import com.ami.ddframe.job.lite.lifecycle.fixture.LifecycleJsonConstants;
...
public class JobSettingsAPIImplTest {
    ...
    public void assertGetDataflowJobSettings() {
        ...
        assertJobSettings(actual, "DATAFLOW", "com.ami.ddframe.job.lite.fixture.TestDataflowJob");
    ...
    public void assertGetScriptJobSettings() {
        ...
        JobSettings actual = jobSettingsAPI.getJobSettings("test_job");
        assertJobSettings(actual, "SCRIPT", "com.ami.ddframe.job.api.script.ScriptJob");
        verify(regCenter).get("/test_job/config");
    }
    ...
    public void assertUpdateJobSettings() {
        ...
        jobSettings.setJobClass("com.ami.ddframe.job.lite.fixture.TestDataflowJob");
        ...
        verify(regCenter).update("/test_job/config", "{\"jobName\":\"test_job\",\"jobClass\":\"com.ami.ddframe.job.lite.fixture.TestDataflowJob\","
