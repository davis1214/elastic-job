...
package com.ami.ddframe.job.lite.lifecycle.fixture;
...
public final class LifecycleJsonConstants {
    ...
    private static final String SIMPLE_JOB_JSON =  "{\"jobName\":\"%s\",\"jobClass\":\"com.ami.ddframe.job.lite.fixture.TestSimpleJob\",\"jobType\":\"SIMPLE\",\"cron\":\"0/1 * * * * ?\","
    ...
    private static final String DATAFLOW_JOB_JSON =  "{\"jobName\":\"test_job\",\"jobClass\":\"com.ami.ddframe.job.lite.fixture.TestDataflowJob\",\"jobType\":\"DATAFLOW\","
    ...
    private static final String SCRIPT_JOB_JSON =  "{\"jobName\":\"%s\",\"jobClass\":\"com.ami.ddframe.job.api.script.ScriptJob\",\"jobType\":\"SCRIPT\",\"cron\":\"0/1 * * * * ?\","
