...
import com.ami.ddframe.job.util.json.AbstractJobConfigurationGsonTypeAdapter;
...
import static com.ami.ddframe.job.lite.internal.config.LiteJobConfigurationConstants.DISABLED;
import static com.ami.ddframe.job.lite.internal.config.LiteJobConfigurationConstants.JOB_SHARDING_STRATEGY_CLASS;
import static com.ami.ddframe.job.lite.internal.config.LiteJobConfigurationConstants.MAX_TIME_DIFF_SECONDS;
import static com.ami.ddframe.job.lite.internal.config.LiteJobConfigurationConstants.MONITOR_EXECUTION;
import static com.ami.ddframe.job.lite.internal.config.LiteJobConfigurationConstants.MONITOR_PORT;
import static com.ami.ddframe.job.lite.internal.config.LiteJobConfigurationConstants.OVERWRITE;
import static com.ami.ddframe.job.lite.internal.config.LiteJobConfigurationConstants.RECONCILE_INTERVAL_MINUTES;
