...
import com.ami.ddframe.job.lite.fixture.TestDataflowJob;
...
public final class LiteJobConfigurationGsonFactoryTest {
    ...
    private String simpleJobJson =  "{\"jobName\":\"test_job\",\"jobClass\":\"com.ami.ddframe.job.lite.fixture.TestSimpleJob\",\"jobType\":\"SIMPLE\",\"cron\":\"0/1 * * * * ?\","
    ...
    private String dataflowJobJson = "{\"jobName\":\"test_job\",\"jobClass\":\"com.ami.ddframe.job.lite.fixture.TestDataflowJob\",\"jobType\":\"DATAFLOW\",\"cron\":\"0/1 * * * * ?\","
    ...
    private String scriptJobJson = "{\"jobName\":\"test_job\",\"jobClass\":\"com.ami.ddframe.job.api.script.ScriptJob\",\"jobType\":\"SCRIPT\",\"cron\":\"0/1 * * * * ?\","
            + "\"shardingTotalCount\":3,\"shardingItemParameters\":\"\",\"jobParameter\":\"\",\"failover\":false,\"misfire\":true,\"description\":\"\","
