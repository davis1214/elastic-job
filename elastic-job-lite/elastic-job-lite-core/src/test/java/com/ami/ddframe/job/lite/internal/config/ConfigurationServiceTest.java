...
public final class ConfigurationServiceTest {
    ...
    public void assertPersistJobConfigurationForJobConflict() {
        ...
        when(jobNodeStorage.getJobNodeDataDirectly(ConfigurationNode.ROOT)).thenReturn(LiteJsonConstants.getJobJson("com.ami.ddframe.job.api.script.api.ScriptJob"));
        try {
