...
package com.ami.ddframe.job.lite.spring.job.parser.common;
...
import com.ami.ddframe.job.lite.spring.api.SpringJobScheduler;
...
import static com.ami.ddframe.job.lite.spring.job.parser.common.BaseJobBeanDefinitionParserTag.*;
...
public abstract class AbstractJobBeanDefinitionParser extends AbstractBeanDefinitionParser {
    ...
    private BeanDefinition createJobCoreBeanDefinition(final Element element) {
        ...
        jobCoreBeanDefinitionBuilder.addConstructorArgValue(element.getAttribute(FIXED_RATE_ATTRIBUTE));
