...
package com.ami.ddframe.job.config;
...
public final class JobCoreConfiguration {
    ...
    public static Builder newBuilder(final String jobName, final int fixedRate, final int shardingTotalCount) {
        return new Builder(jobName, "", shardingTotalCount).fixedRate(fixedRate);
    }
    ...
    public static class Builder {
        ...
        public Builder fixedRate(int fixedRate) {
        ...
        public final JobCoreConfiguration build() {
            ...
            Preconditions.checkArgument(!Strings.isNullOrEmpty(cron) || fixedRate > 0, "cron can not be empty while fixedRate is 0.");
            Preconditions.checkArgument(shardingTotalCount > 0, "shardingTotalCount should larger than zero.");
            return new JobCoreConfiguration(jobName, cron, shardingTotalCount, shardingItemParameters, jobParameter,
                    failover, misfire, description, jobProperties, fixedRate);
        }
    }
}
